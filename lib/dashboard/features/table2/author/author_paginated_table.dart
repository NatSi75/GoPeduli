...
class GoPeduliPaginatedTableAuthor extends StatelessWidget {
  const GoPeduliPaginatedTableAuthor({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        ...
        Visibility(
          visible: false,
          child: Text(controller.filteredAuthors.length.toString()),
        );
