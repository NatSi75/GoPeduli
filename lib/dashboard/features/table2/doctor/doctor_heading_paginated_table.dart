...
class GoPeduliHeadingPaginatedTableDoctor extends StatelessWidget {
  const GoPeduliHeadingPaginatedTableDoctor({super.key});
              ...
              children: [
                SizedBox(
                  ...
                  child: ElevatedButton(
                      onPressed: () => Get.toNamed(GoPeduliRoutes.createDoctor),
