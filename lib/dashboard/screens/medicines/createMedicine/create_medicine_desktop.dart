...
import 'package:gopeduli/dashboard/features/form/medicine/create_medicine_form.dart';
...
class CreateMedicineDesktop extends StatelessWidget {
  const CreateMedicineDesktop({super.key});
