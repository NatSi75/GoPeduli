...
import 'package:gopeduli/dashboard/features/form/doctor/create_doctor_form.dart';
...
class CreateDoctorDesktop extends StatelessWidget {
  const CreateDoctorDesktop({super.key});
          ...
          child: Column(
            ...
            children: [
              const GoPeduliBreadCrumbsWithHeading(
                  ...
                  breadcrumbItems: [GoPeduliRoutes.doctors, 'Create Doctor']),
              const SizedBox(
