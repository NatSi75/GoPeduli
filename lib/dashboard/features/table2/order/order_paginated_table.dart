...
class GoPeduliPaginatedTableOrder extends StatelessWidget {
  const GoPeduliPaginatedTableOrder({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        ...
        Visibility(
          visible: false,
          child: Text(controller.filteredOrders.length.toString()),
        );
