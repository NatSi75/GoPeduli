...
class GoPeduliPaginatedTableCourier extends StatelessWidget {
  const GoPeduliPaginatedTableCourier({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        ...
        Visibility(
          visible: false,
          child: Text(controller.filteredCouriers.length.toString()),
        );
