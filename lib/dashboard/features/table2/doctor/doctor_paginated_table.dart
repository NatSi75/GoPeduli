...
class GoPeduliPaginatedTableDoctor extends StatelessWidget {
  const GoPeduliPaginatedTableDoctor({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        ...
        Visibility(
          visible: false,
          child: Text(controller.filteredDoctors.length.toString()),
        );
