...
import 'package:gopeduli/dashboard/controllers/courier/create_courier_controller.dart';
...
class CreateCourierForm extends StatelessWidget {
  const CreateCourierForm({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(CreateCourierController());
    return Form(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                  onPressed: () => controller.registerCourier(),
