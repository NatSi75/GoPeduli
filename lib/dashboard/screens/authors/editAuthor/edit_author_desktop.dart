...
import 'package:gopeduli/dashboard/features/form/author/edit_author_form.dart';
...
class EditAuthorDesktop extends StatelessWidget {
  const EditAuthorDesktop({super.key, required this.author});
          ...
          child: Column(
            ...
            children: [
              const GoPeduliBreadCrumbsWithHeading(
                  ...
                  heading: 'Edit Author',
                  breadcrumbItems: [GoPeduliRoutes.authors, 'Edit Author']),
              const SizedBox(
              ...
              Container(
                ...
                child: EditAuthorForm(author: author),
              ),
            ],
          ),
        ),
