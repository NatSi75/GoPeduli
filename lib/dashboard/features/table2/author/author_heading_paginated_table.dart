...
class GoPeduliHeadingPaginatedTableAuthor extends StatelessWidget {
  const GoPeduliHeadingPaginatedTableAuthor({super.key});

  @override
  Widget build(BuildContext context) {
    final AuthorController controller = Get.put(AuthorController());
    return Padding(
              ...
              children: [
                SizedBox(
                  ...
                  child: ElevatedButton(
                      onPressed: () => Get.toNamed(GoPeduliRoutes.createAuthor),
