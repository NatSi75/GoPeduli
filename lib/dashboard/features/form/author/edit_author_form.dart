...
import 'package:gopeduli/dashboard/controllers/author/edit_author_controller.dart';
...
class EditAuthorForm extends StatelessWidget {
  const EditAuthorForm({super.key, required this.author});

  final AuthorModel author;

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditAuthorController());
    controller.init(author);
    return Form(
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              validator: (value) =>
                  GoPeduliValidator.validateEmptyText('Phone Number', value),
              cursorColor: GoPeduliColors.primary,
              style: const TextStyle(
                  fontSize: GoPeduliSize.fontSizeBody, color: Colors.black),
              decoration: const InputDecoration(
